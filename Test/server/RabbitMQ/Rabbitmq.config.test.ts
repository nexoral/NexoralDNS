...
import { RabbitMQService } from '@nexoralShared/RabbitMQ/Rabbitmq.config';
...
import type { RabbitMQPublisher } from '@nexoralShared/RabbitMQ/RabbitMQPublisher';
import type { RabbitMQConsumer } from '@nexoralShared/RabbitMQ/RabbitMQConsumer';
