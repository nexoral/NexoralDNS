  ...
  return (
    <div className="bg-[var(--card-bg)] rounded-xl border border-[var(--border-2)] p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-[var(--text-1)]">System Status</h3>
          <p className="text-sm text-[var(--text-3)]">Real-time server metrics</p>
        </div>
          ...
          <div key={metric.name} className="animate-fade-in-up" style={{ animationDelay: `${index * 100}ms` }}>
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-[var(--text-2)]">{metric.name}</span>
              </div>
              <span className="text-sm font-semibold text-[var(--text-1)]">{metric.value}%</span>
            </div>
      ...
      <div className="mt-6 pt-4 border-t border-[var(--border-2)]">
        <div className="grid grid-cols-2 gap-4 text-center">
          <div>
            ...
            <p className="text-xs text-[var(--text-3)]">Uptime</p>
          </div>
          <div>
            <p className="text-2xl font-bold text-[var(--blue)]">156ms</p>
            <p className="text-xs text-[var(--text-3)]">Avg Response</p>
          </div>
        </div>
      </div>
    </div>
