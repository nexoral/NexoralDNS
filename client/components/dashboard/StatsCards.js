    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-4 lg:mb-6">
        ...
        <div className="bg-[rgba(91,140,255,0.07)] rounded-xl border border-[rgba(91,140,255,0.18)] p-6 hover:border-[rgba(91,140,255,0.3)] hover:bg-[rgba(91,140,255,0.1)] transition-all duration-200 nd-rise">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-xs font-semibold text-[var(--blue)] uppercase tracking-wide">DNS Queries (24h)</h3>
          ...
          <div className="text-3xl font-bold text-[var(--text-1)] mb-2">{stats.totalQueries?.toLocaleString() || 0}</div>
          <p className="text-xs text-[var(--blue)]/80">Total queries processed</p>
        </div>
        ...
        <div className="bg-[rgba(61,220,132,0.07)] rounded-xl border border-[rgba(61,220,132,0.18)] p-6 hover:border-[rgba(61,220,132,0.3)] hover:bg-[rgba(61,220,132,0.1)] transition-all duration-200 nd-rise" style={{ animationDelay: '0.05s' }}>
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-xs font-semibold text-[var(--green)] uppercase tracking-wide">Total Domains</h3>
          ...
          <div className="text-3xl font-bold text-[var(--text-1)] mb-2">{stats.totalDomains || 0}</div>
          <p className="text-xs text-[var(--green)]/80">Configured in system</p>
        </div>
        ...
        <div className="bg-[rgba(246,179,82,0.07)] rounded-xl border border-[rgba(246,179,82,0.18)] p-6 hover:border-[rgba(246,179,82,0.3)] hover:bg-[rgba(246,179,82,0.1)] transition-all duration-200 nd-rise" style={{ animationDelay: '0.1s' }}>
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-xs font-semibold text-[var(--amber)] uppercase tracking-wide">Active Domains</h3>
          ...
          <div className="text-3xl font-bold text-[var(--text-1)] mb-2">{stats.activeDomains || 0}</div>
          <p className="text-xs text-[var(--amber)]/80">Currently active</p>
        </div>
        ...
        <div className="bg-[rgba(167,139,250,0.07)] rounded-xl border border-[rgba(167,139,250,0.18)] p-6 hover:border-[rgba(167,139,250,0.3)] hover:bg-[rgba(167,139,250,0.1)] transition-all duration-200 nd-rise" style={{ animationDelay: '0.15s' }}>
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-xs font-semibold text-[var(--purple)] uppercase tracking-wide">DNS Records</h3>
          ...
          <div className="text-3xl font-bold text-[var(--text-1)] mb-2">{stats.totalDNSRecords || 0}</div>
          <p className="text-xs text-[var(--purple)]/80">Total records</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
        ...
        <div className="bg-[rgba(52,225,212,0.07)] rounded-xl border border-[rgba(52,225,212,0.18)] p-5 hover:border-[rgba(52,225,212,0.3)] hover:bg-[rgba(52,225,212,0.1)] transition-all duration-200">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-xs font-semibold text-[var(--teal)] uppercase tracking-wide">Forwarded (24h)</h3>
          ...
          <div className="text-2xl font-bold text-[var(--text-1)] mb-1">
            {stats.totalForwardedQueries?.toLocaleString() || 0}
          </div>
          <div className="flex items-center justify-between">
            <p className="text-xs text-[var(--teal)]/80">Sent to upstream</p>
            <span className="text-xs font-semibold text-[var(--teal)] bg-[rgba(52,225,212,0.15)] px-2 py-0.5 rounded-full">
        ...
        <div className="bg-[rgba(61,220,132,0.07)] rounded-xl border border-[rgba(61,220,132,0.18)] p-5 hover:border-[rgba(61,220,132,0.3)] hover:bg-[rgba(61,220,132,0.1)] transition-all duration-200">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-xs font-semibold text-[var(--green)] uppercase tracking-wide">Resolved (24h)</h3>
          ...
          <div className="flex items-center justify-between">
            <p className="text-xs text-[var(--green)]/80">Successfully resolved</p>
            <span className="text-xs font-semibold text-[var(--green)] bg-[rgba(61,220,132,0.15)] px-2 py-0.5 rounded-full">
        ...
        <div className="bg-[rgba(255,96,113,0.07)] rounded-xl border border-[rgba(255,96,113,0.18)] p-5 hover:border-[rgba(255,96,113,0.3)] hover:bg-[rgba(255,96,113,0.1)] transition-all duration-200">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-xs font-semibold text-[var(--red)] uppercase tracking-wide">Failed (24h)</h3>
          ...
          <div className="flex items-center justify-between">
            <p className="text-xs text-[var(--red)]/80">Query errors</p>
            <span className="text-xs font-semibold text-[var(--red)] bg-[rgba(255,96,113,0.15)] px-2 py-0.5 rounded-full">
      ...
      <div className="grid grid-cols-1 gap-4 lg:gap-6 mt-4 lg:mt-6">
        <div className="bg-[rgba(91,140,255,0.07)] rounded-xl border border-[rgba(91,140,255,0.18)] p-5 hover:border-[rgba(91,140,255,0.3)] transition-all duration-200">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-xs font-semibold text-[var(--blue)] uppercase tracking-wide">Avg Resolve Time</h3>
          ...
          <div className="text-2xl font-bold text-[var(--text-1)] mb-1">
            {stats.avgResponseTime || 0} <span className="text-base font-semibold text-[var(--blue)]">ms</span>
          </div>
          <p className="text-xs text-[var(--blue)]/80">
